...
import { useGameStore, useSelectedAgentIds, useAgentsMap, useAgentsShallow, useQuestsShallow, useDragonsShallow, useSelection, useAgentCount, useDragonCount, useQuestCount, useCompletedQuestCount, type GameAgent, type Tool } from "@/lib/store";
import { useAgentBridgeContext } from "@/components/bridge/AgentBridge";
import { useCombat } from "@/components/entities/Dragon";
import { ToolCard, ToolListItem, ToolIcon, RarityBadge, TOOL_TYPE_CONFIG, RARITY_CONFIG } from "./ToolCard";
import { screenToWorld } from "@/components/core/CameraController";
import { useAgentBridge } from "@/components/bridge/AgentBridge";
