...
// Explicit return types prevent TypeScript inference issues with shallow comparator
export const useAgentsShallow = (): Record<string, GameAgent> => useGameStore((state) => state.agents, shallow);
export const useDragonsShallow = (): Record<string, Dragon> => useGameStore((state) => state.dragons, shallow);
export const useStructuresShallow = (): Record<string, Structure> => useGameStore((state) => state.structures, shallow);
export const useQuestsShallow = (): Record<string, Quest> => useGameStore((state) => state.quests, shallow);
export const useTilesShallow = (): Record<string, Tile> => useGameStore((state) => state.tiles, shallow);
export const usePartiesShallow = (): Record<string, Party> => useGameStore((state) => state.parties, shallow);
